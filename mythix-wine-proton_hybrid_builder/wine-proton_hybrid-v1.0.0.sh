...
# ============================================================================
# Hybrid Wine/Proton Installer  —  mythix edition
# ============================================================================
...
#
# Usage:
#   ./wine-proton_mythix-unified.sh [OPTIONS]
#
...
do_uninstall() {
  ...
  if [ -z "$name" ]; then
    read -rp "  Tool name to uninstall [wine-proton_mythix]: " name
    name="${name:-wine-proton_mythix}"
  fi
...
${C_BOLD}Hybrid Wine/Proton Installer  —  mythix edition  v${VERSION}${C_RESET}
...
printf '  ╔══════════════════════════════════════════════════════════════╗\n'
printf '  ║                                                              ║\n'
printf '  ║  🍷  Hybrid Wine/Proton Installer  —  mythix edition          ║\n'
...
if [ -n "$CLI_TOOL_NAME" ]; then
  ...
  read -rp "  Tool name [wine-proton_mythix]: " TOOL_NAME
  TOOL_NAME="${TOOL_NAME:-wine-proton_mythix}"
fi
...
# Generated by wine-proton_mythix-unified.sh v${VERSION}
